...
class AuthorImplTest {
    ...
    void setUp() {
        ...
        aemContext.load().json("/com/adobe/aem/media/core/models/author/Author.json","/component");
        aemContext.load().json("/com/adobe/aem/media/core/models/author/Page.json","/page");
        aemContext.load().json("/com/adobe/aem/media/core/models/author/Resource.json","/resource");
    }
